    ...
    <footer className="bg-foreground text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">WA Pedidos</span>
            </div>
            <p className="text-white/70 text-sm leading-relaxed">
              La forma más simple de vender por WhatsApp para comercios argentinos.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="#caracteristicas" className="text-white/70 hover:text-white transition-colors">
                  Características
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="#preguntas" className="text-white/70 hover:text-white transition-colors">
                  FAQ
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-white/10 text-center text-sm text-white/60">
          <p>&copy; {new Date().getFullYear()} WA Pedidos. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
